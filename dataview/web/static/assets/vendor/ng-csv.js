...
//console.log('this.stringify = function (data, options) this --->');
//console.log(angular.isDefined(options.header));
      ...
      controller: [
        ...
        function ($scope, $element, $attrs, $transclude) {
          ...
          function getBuildCsvOptions() {
            ...
            //console.log('getBuildCsvOptions options >>>> ');
            //console.log(angular.isDefined($attrs.csvHeader));
...
//console.log('end of deferred.resolve(csv)');              
            });
...
// //console.log('ng-csv ------------------- scope.getFilename() ');
